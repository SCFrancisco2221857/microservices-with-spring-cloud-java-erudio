...
* The original package name 'com.example.rest-with-spring-boot-and-java-erudio' is invalid and this project uses 'com.example.rest_with_spring_boot_and_java_erudio' instead.
